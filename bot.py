...
#
#  Файл: bot.py, Версия v1.682, последнее изменение: 02.06.2026
...
def _sync_udp_policy_config():
    payload = (
        ...
        f'BYPASS_UDP_QUIC_BLOCK_SHADOWSOCKS={1 if UDP_QUIC_BLOCK_SHADOWSOCKS_ENABLED else 0}\n'
        f'BYPASS_UDP_QUIC_BLOCK_VMESS={1 if UDP_QUIC_BLOCK_VMESS_ENABLED else 0}\n'
        f'BYPASS_UDP_QUIC_BLOCK_VLESS={1 if UDP_QUIC_BLOCK_VLESS_ENABLED else 0}\n'
        f'BYPASS_UDP_QUIC_BLOCK_VLESS2={1 if UDP_QUIC_BLOCK_VLESS2_ENABLED else 0}\n'
        f'BYPASS_UDP_QUIC_BLOCK_TROJAN={1 if UDP_QUIC_BLOCK_TROJAN_ENABLED else 0}\n'
