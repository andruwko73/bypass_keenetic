...
#
#  Файл: bot.py, Версия v1.639, последнее изменение: 25.05.2026
...
SOCIALNET_SERVICE_KEYS = ('chatgpt_services', 'claude', 'gemini', 'youtube', 'telegram', 'chrome_remote_desktop', 'meta', 'discord', 'tiktok', 'twitter')
