...
subscription_fallback_proxy_urls = ('socks5h://127.0.0.1:10811', 'socks5h://127.0.0.1:10813')
subscription_pool_route_fallback_enabled = True
...
memory_watchdog_enabled = True  # аварийная защита при действительно высоком RSS
...
youtube_edge_prefetch_interval_seconds = 7200  # guarded external refresh every two hours
