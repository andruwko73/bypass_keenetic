...
backup_path "$BOT_DIR/CHANGELOG.md"
...
pool_probe_inprocess_fallback_enabled = False
pool_probe_process_worker_poll_seconds = 0.75
pool_failover_process_worker_enabled = True
...
status_refresh_pending_min_interval_seconds = 60.0
router_health_cache_ttl = 30.0
...
background_task_critical_max_bot_rss_kb = 71680
background_task_max_program_rss_kb = 102400
...
auto_failover_idle_log_interval_seconds = 900
subscription_auto_refresh_interval_seconds = 21600
subscription_auto_refresh_check_seconds = 300
subscription_auto_refresh_max_bot_rss_kb = 81920
subscription_auto_refresh_max_program_rss_kb = 112640
...
subscription_nightly_pool_probe_enabled = True
subscription_nightly_pool_probe_start_hour = 3
subscription_nightly_pool_probe_end_hour = 6
subscription_nightly_pool_probe_max_refresh_age_seconds = 28800
...
event_history_duplicate_window_seconds = 300
