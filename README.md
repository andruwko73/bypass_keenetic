...
6. Используйте **Пул ключей** для хранения нескольких ключей: выбранный ключ можно применить кликом, отдельный ключ удалить кнопкой **✕**, новые ключи загрузить вручную или через subscription, а весь пул очистить кнопкой **Очистить пул**.
...
- список ключей отображается страницами, а нижние кнопки **✅ номер** и **✕ номер** применяют или удаляют конкретный ключ;
