...
- все ключи выбранного протокола выводятся в прокручиваемой нижней клавиатуре с названием, номером и статусами **🔵✈️** Telegram / **🔴▶️** YouTube; нажатие на кнопку ключа применяет его;
