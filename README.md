...
При первой чистой установке откроется страница первичной настройки на `http://192.168.1.1:8080/`: BotFather token и Telegram username. Если Telegram-бот не нужен, нажмите **Запустить режим Web only** — включится та же единая версия без Telegram-бота.
...
- **Статус** — связь с Telegram API, текущий режим, быстрый старт и сервисные команды;
...
Режимы:
- **Простой** — интерфейс и Telegram-бот, без пула ключей и расширенных проверок;
...
Команда переустановки доступна в Telegram-боте:
