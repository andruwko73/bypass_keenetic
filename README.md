...
- готовые пресеты проверок: ChatGPT/OpenAI/Codex, Claude, Gemini, Copilot, Perplexity, Grok, DeepSeek, Le Chat, Meta AI, Instagram, Facebook;
...
Опасные сервисные действия в Telegram также требуют подтверждения: удаление компонентов, DNS Override и перезагрузка роутера.
