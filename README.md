...
- список ключей отображается страницами, а сами ключи выводятся в нижних кнопках с названием, номером и статусом проверки; нажатие на кнопку ключа применяет его;
- длинный пул листается кнопками **Ключи ◀️** / **Ключи ▶️**, при этом служебные кнопки **Добавить**, **Проверить**, **Удаление** и навигация остаются в нижней части каждой страницы;
