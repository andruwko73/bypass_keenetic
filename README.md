...
- Ленивую загрузку тяжёлых панелей пула и проверок: первичная страница не тянет все протоколы сразу.
- Прогрев YouTube при установке и обновлении отдельным коротким процессом, без роста постоянного RSS Telegram-бота.
...
Прогрев YouTube ставится сразу при чистой установке и обновлениях. Он выполняется отдельным коротким процессом и не увеличивает постоянный RSS Telegram-бота.
