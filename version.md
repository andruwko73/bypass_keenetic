*v1.551 (10 May 2026) -* main
*Исправлены дрожание выделения и задержка Liquid Glass: убрано перезапускание эффекта при удержании на одной кнопке, добавлена пауза после нажатия и более мягкий эффект лупы.*
