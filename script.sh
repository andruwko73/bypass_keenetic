...
repo="andruwko73"
REPO_REF="${REPO_REF:-codex/web-only-v1}"
...
BOT_RUNTIME_MODULES="pool_probe_runner.py key_pool_store.py key_pool_web.py probe_cache.py custom_checks_store.py service_catalog.py web_form_template.py web_form_blocks.py web_pool_form_blocks.py web_http_common.py web_get_actions.py web_post_actions.py web_command_state.py unblock_lists.py proxy_key_store.py proxy_protocols.py proxy_config_builder.py proxy_status.py"
